        ...
        <div>
            ...
            <Grid className="about-container" container spacing={3}>
                ...
                <Grid item sm={12} md={6}>
                    <div className="about-text-container">
                        ...
                        <p className="about-paragraph">After wrapping up second year, I’ve started a new internship at<a href="https://global.medical.canon/" className="underline-links">Canon</a> as a software developer.</p>
            ...
            <Grid container className="hobbies-container" spacing={0}>
                    ...
                    <Grid item className="hobby" sm={12} md={5}>
                        ...
                        <p className="hobby-content">My toxic trait is spending waaaaay too much money on yarn. It's true! Once I actually got 30+ balls of yarn at a garage sale for $10. Hence, my mum was not impressed. </p>
